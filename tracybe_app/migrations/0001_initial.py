    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(max_length=250)),
                ('caracteristica', models.CharField(blank=True, default='', max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciclo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listacicloequipo', to='tracybe_app.ciclo')),
                ('estatus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listaestatusequipo', to='tracybe_app.estatus')),
                ('tipoequipo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listatipoequipoequipo', to='tracybe_app.tipoequipo')),
            ],
        ),
        migrations.CreateModel(
            name='Evento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('update', models.DateTimeField(auto_now=True)),
                ('empaque', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listaempaqueinstrumento', to='tracybe_app.empaque')),
            ],
        ),
        migrations.CreateModel(
            name='EventoLavado',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empaque', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listaempaqueset', to='tracybe_app.empaque')),
            ],
        ),
        migrations.AddField(
            model_name='instrumento',
            name='set',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listainstrumento', to='tracybe_app.set'),
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('sala', models.CharField(blank=True, default='', max_length=100, null=True)),
                ...
                ('anestesiologo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listaanestesiologoticket', to=settings.AUTH_USER_MODEL)),
                ('area_registro', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listaarearegistroticket', to='tracybe_app.areasolicitante')),
                ('cirujano', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listacirujanoticket', to=settings.AUTH_USER_MODEL)),
                ('enfermero', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listaenfermeroticket', to=settings.AUTH_USER_MODEL)),
                ('instrumento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listainstrumentoticket', to='tracybe_app.instrumento')),
                ('paciente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listapacienteticket', to='tracybe_app.paciente')),
                ('residente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listaresidenteticket', to=settings.AUTH_USER_MODEL)),
                ('set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listasetticket', to='tracybe_app.set')),
                ('solicita', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listasolicitaticket', to=settings.AUTH_USER_MODEL)),
                ('turno', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listaturnoticket', to='tracybe_app.turno')),
            ],
        ),
    ]
